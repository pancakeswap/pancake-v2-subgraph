...
export const FACTORY_ADDRESS = Address.fromString('0xBCfCcbde45cE874adCB698cC183deBcF17952812')

export const LOCKUP_BLOCK_NUMBER = BigInt.fromI32(586851)

export const MASTER_CHEF_ADDRESS = Address.fromString('0x73feaa1eE314F8c655E354234017bE2193C9E24E')

export const SUSHI_BAR_ADDRESS = Address.fromString('')

export const SUSHI_MAKER_ADDRESS = Address.fromString('')

export const SUSHI_TOKEN_ADDRESS = Address.fromString('0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82')
...
export const MASTER_CHEF_START_BLOCK = BigInt.fromI32(699498)
